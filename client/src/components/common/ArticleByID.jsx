...
function ArticleByID() {
  ...
  async function onSave(modifiedArticle) {
    ...
    let res = await axios.put(
      `${import.meta.env.local.URL}/author-api/article/${articleAfterChanges.articleId}`,
      articleAfterChanges,
  ...
  async function addComment(commentObj) {
    ...
    let res = await axios.put(
      `${import.meta.env.local.URL}/user-api/comment/${currentArticle.articleId}`,
      commentObj
    );
  ...
  async function deleteArticle() {
    ...
    let res = await axios.put(
      `${import.meta.env.local.URL}/author-api/articles/${state.articleId}`,
      state
    );
